...
while True:
    ...
    #Stores full planets
    full_planets = []
    #if the planned planet is  not full
    planned_my_planets_not_full = []
    ...
    for ship in game_map.get_me().all_ships():
        ...
        closest_my_planet_notFull = [entities_by_distance[distance][0] for distance in entities_by_distance if isinstance(entities_by_distance[distance][0], hlt.entity.Planet) and entities_by_distance[distance][0].is_owned() and entities_by_distance[distance][0].owner == ship.owner and not entities_by_distance[distance][0].is_full() and entities_by_distance[distance][0] not in full_planets and entities_by_distance[distance][0] not in planned_my_planets_not_full]
        ...
        if len(closest_my_planet_notFull) > 0:
            ...
            if ship in team_attackships:
                ...
                if navigate_command:
                    command_queue.append(navigate_command)
                    planned_my_planets_not_full.append(target_planet)
